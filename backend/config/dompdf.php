...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var string
         */
        // dompdf's bundled 'serif'/'sans-serif' aliases don't cover Polish
        // diacritics (ą, ć, ę, ł, ń, ó, ś, ź, ż) — DejaVu Sans does, and
        // ships with dompdf, so no extra font asset is needed. Plan exports
        // are bilingual (PL/EN), so this must render both correctly.
