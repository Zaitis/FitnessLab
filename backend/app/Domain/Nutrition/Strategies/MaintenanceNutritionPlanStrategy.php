...
/**
 * Calorie target at estimated maintenance (TDEE), with a balanced macro
 * split — no deficit or surplus, unlike the other two goals.
 */
final class MaintenanceNutritionPlanStrategy implements NutritionPlanStrategy
{
    ...
    private const float CARBS_SHARE = 0.40;
